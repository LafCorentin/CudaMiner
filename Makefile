...
.cu.o:
	$(NVCC) -O3 -Xptxas "-v" -arch=sm_90 --maxrregcount=64 --ptxas-options=-v $(JANSSON_INCLUDES) -o $@ -c $<
...
fermi_kernel.o: fermi_kernel.cu
	$(NVCC) -O3 -Xptxas "-v" -arch=sm_90 --maxrregcount=64 $(JANSSON_INCLUDES) -o $@ -c $<

kepler_kernel.o: kepler_kernel.cu
	$(NVCC) -O3 -Xptxas "-v" -arch=sm_90 --maxrregcount=32 $(JANSSON_INCLUDES) -o $@ -c $<
...
nv_kernel.o: nv_kernel.cu
	$(NVCC) -O3 -Xptxas "-v" -arch=sm_90 --maxrregcount=63 $(JANSSON_INCLUDES) -o $@ -c $<

nv_kernel2.o: nv_kernel2.cu
	$(NVCC) -O3 -Xptxas "-v" -arch=sm_90 --maxrregcount=80 $(JANSSON_INCLUDES) -o $@ -c $<
